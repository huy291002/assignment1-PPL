...
program:  (funcdecl|vardecl|statement)+ EOF ;
...
//function
funcdecl: Identifiers COLON FUNCTION returntyp LB parameterlist RB (subpart)? body;
//funcproto: Identifiers COLON FUNCTION returntyp LB parameterlist RB (subpart)?;

returntyp: actomic|VOID|ARRAY|AUTO;
...
// for statement
forstmt: FOR LB (scalar_variable EQ init_expr CM condition_expr CM update_expr) RB statement ;
init_expr: Integer;
condition_expr: expr;
update_expr: expr;
// while
...
block_stmtprime: vardecl | statements;
